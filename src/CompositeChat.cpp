...
cCompositeChat::cCompositeChat(const cParsedNBT & a_ParsedNbt) :
	m_MessageType(mtCustom)
{
...
AString cCompositeChat::ExtractText(void) const
{
	...
	{
		std::visit(OverloadedVariantAccess {
					   [&Msg](const TextPart & a_Part)
		{ Msg.append(a_Part.Text); },
					   [&Msg](const ClientTranslatedPart & a_Part)
		{ Msg.append(a_Part.Text); },
					   [&Msg](const UrlPart & a_Part)
		{ Msg.append(a_Part.Url); },
					   [&Msg](const RunCommandPart & a_Part)
		{ Msg.append(a_Part.Text); },
					   [&Msg](const SuggestCommandPart & a_Part)
		{ Msg.append(a_Part.Text); },
